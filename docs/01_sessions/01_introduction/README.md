...
Create a visual pattern yourself. The pattern must be repetitive - and hand-drawn :D. It can either be abstracted (CTech) or realism oriented (VFX) or both 😉.
...
Choose one "traditional" painting that is inspirational to you. The image can come from the script or you can refer to any artist or image you like. It can either be abstracted (CTech) or realism oriented (VFX).
...
If you are completely new to Unreal, the goal of this task is that you get familiar with Unreal and its interface. Specifically in the reference, I recommend that you work through:
