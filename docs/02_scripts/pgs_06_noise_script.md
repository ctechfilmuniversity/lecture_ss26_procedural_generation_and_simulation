...
![noise_01](img/noise/noise_01.png)  
![noise_05](img/noise/noise_05.png)  
![noise_02](img/noise/noise_02.png)![noise_04](img/noise/noise_04.png)  
![noise_06](img/noise/noise_06.png)  
![noise_03](img/noise/noise_03.gif)![noise_12](img/noise/noise_12.png)
![noise_10](img/noise/noise_10.png)  

![noise_07](img/noise/noise_07.png)![noise_08](img/noise/noise_08.png)  
![noise_09](img/noise/noise_09.png)![noise_11](img/noise/noise_11.png)  
...
![noise_13](img/noise/noise_13.png)  
[[Perlin, K. (1985). An Image Synthesizer.]]()

![noise_14](img/noise/noise_14.png)  
...
![noise_15](img/noise/noise_15.png)  
[[wiki]](https://commons.wikimedia.org/wiki/File:Terragen_2.jpg#/media/File:Terragen_2.jpg)

![noise_17](img/noise/noise_17.png)

Houdini also has a special height field functionality, for which a volume on a 2D grid represents the distance of the terrain at each point on the map from the ground plane (the values can be negative).

![noise_18](img/noise/noise_18.png)  
...
![noise_16](img/noise/noise_16.png)
...
![bump_displace_01](img/noise/bump_displace_01.png)  
[[talkgraphics]](https://www.talkgraphics.com/showthread.php?16280-Displacement-Maps-vs-Bump-Maps)

![bump_displace_02](img/noise/bump_displace_02.png)  
...
![noise_19](img/noise/noise_19.png)  
[[Perlin, K. (1985). An Image Synthesizer.]]()
...
When thinking about a practically usable random noise function, we probably think about something like this:

![noise_24](img/noise/noise_24.png)  
...
![noise_25](img/noise/noise_25.png)  
[[scratchapixel]](https://www.scratchapixel.com/lessons/procedural-generation-virtual-worlds)
...
![noise_26](img/noise/noise_26.png)  
[[scratchapixel]](https://www.scratchapixel.com/lessons/procedural-generation-virtual-worlds)
...
2. No Periodicity
    ...
    ![noise_27](img/noise/noise_27.png)  
    *[Visible periodicity]*
...
6. Band Limited Frequency Content
    ...
    ![noise-aliasing](img/noise/noise-aliasing.gif)  
...
![noise_29](img/noise/noise_29.png)  
...
Back to the original question, how do we go from random numbers (left example, image above) to a well-behaved noise function, which fulfills the requirements of the last section (right example, image above)?
...
Hence, what the hash function in the context of RNGs does is to transform input with math operations into output a that looks random. These functions actually do repeat after a long period but usually non-noticeable for our applications.
...
When using any kind of RNG it is important that you pay attention to its output range and whether that fits to your needs. Usually you can assume a range from [-1, 1].
...
![noise_30](img/noise/noise_30.png)
...
![tron](img/noise/tron.png) [3]

Perlin published his results in the seminal publication
...
![perlin](img/noise/perlin.png)

And in 2002 as a follow-up (a Siggraph paper with only two pages!)
...
![perlin_01](img/noise/perlin_01.png)  
...
![perlin_02](img/noise/perlin_02.png)  
...
![perlin_03](img/noise/perlin_03.png)  
...
![perlin_04](img/noise/perlin_04.png)  
[[scratchapixel]](https://www.scratchapixel.com/lessons/procedural-generation-virtual-worlds/perlin-noise-part-2)
...
![perlin_05](img/noise/perlin_05.png)  
[[scratchapixel]](https://www.scratchapixel.com/lessons/procedural-generation-virtual-worlds/perlin-noise-part-2)
...
![perlin_07](img/noise/perlin_07.png)  
...
![perlin_10](img/noise/perlin_10.png)  
[[webstaff.itn.liu.se]](http://webstaff.itn.liu.se/~stegu/simplexnoise/simplexnoise.pdf)

The difference vector is *(0,0,0)* (and the dot product 0) when *P* lies exactly on the grid such as

![perlin_11](img/noise/perlin_11.png)  
[[wiki]](https://en.wikipedia.org/wiki/Perlin_noise)

Here, an overall comparison of the gradient noise to a simple value noise

![perlin_12](img/noise/perlin_12.png)  
[[iquilezles]](http://www.iquilezles.org/)

Changing the interpolation also leads to visible differences

![perlin_13](img/noise/perlin_13.png)  
[[2]]

### Simplex Noise

Perlin was still not satisfied with his gradient noise and presented in 2001 the *simplex noise*. For the simplex noise Perlin replaced a grid tiling of a space with a triangular tiling such as

![simplex_01](img/noise/simplex_01.png)  
[[webstaff.itn.liu.se]](http://webstaff.itn.liu.se/~stegu/simplexnoise/simplexnoise.pdf)
...
![simplex_02](img/noise/simplex_02.png)  
[[iquilezles]](http://www.iquilezles.org/)

### `noise()`

As mentioned before, in almost all environments we are using you have pre-defined noise functions such as 
...
![amplitude](img/noise/amplitude.png)

### Frequency

The frequency parameter can be understood as the density of the noise, or its *bumpiness*.

![frequency](img/noise/frequency.png)

![frequency_01](img/noise/frequency_01.png) ![frequency_02](img/noise/frequency_02.png)  
[[2]]()
...
![noise-curve-offset](img/noise/noise-curve-offset.gif)
...
![turbulence_02](img/noise/turbulence_02.png)  
...
![turbulence_03](img/noise/turbulence_03.png)  
[[2]]()

2D:

![turbulence_01](img/noise/turbulence_01.png)  
...
![turbulence_04](img/noise/turbulence_04.png)
...
![turbulence_05](img/noise/turbulence_05.png)

Hence, the levels are

![turbulence_07](img/noise/turbulence_07.png)

![turbulence_06](img/noise/turbulence_06.png)  
[[2]]()
...
![cellular_01](img/noise/cellular_01.png)  
...
![cellular_02](img/noise/cellular_02.png)  
...
To check all points for all pixels is costly and the algorithm becomes with the naive implementation as shown above, almost unusable. As optimization we rather divide the space into tiles and have one point per tile. Then you only need to check a pixel’s tile and the neighboring ones for the closes distance. For a detailed explanation, please see [[The Book of Shaders]](https://thebookofshaders.com/12/) (highly recommended).

![cellular_03](img/noise/cellular_03.png)  
[[thebookofshaders]](https://thebookofshaders.com/12/)


![worley](img/noise/worley.gif)  
[[thebookofshaders]](https://thebookofshaders.com/12/)
...
![cellular_04](img/noise/cellular_04.png)  
[[thebookofshaders]](https://thebookofshaders.com/12/)
...
![voronoi_growth_euclidean](img/noise/voronoi_growth_euclidean.gif)  
...
![voronoi_01](img/noise/voronoi_01.png)  
...
![voronoi_08](img/noise/voronoi_08.png)  
[[thebookofshaders]](https://thebookofshaders.com/12/)*Extended Voronoi - Leo Solaas (2011)*

![voronoi_animated](img/noise/voronoi_animated.gif)  
[[thebookofshaders]](https://thebookofshaders.com/12/)

![voronoi_09](img/noise/voronoi_09.png)  
...
Delaunay Triangulation is a technique for creating a mesh of contiguous, non-overlapping triangles from a set of points.

![delaunay_01](img/noise/delaunay_01.png)  
...
![delaunay_02](img/noise/delaunay_02.png)  
[[samuelp]](http://www.geom.uiuc.edu/~samuelp/del_project.html)

Delaunay Triangulation is a triangulation such that no point is inside the circumcircle of any triangle.
...
![delaunay_04](img/noise/delaunay_04.png)  
...
[![voronoi_07](img/noise/voronoi_07.png)](https://medium.com/@jakerice_7202/voronoi-for-the-people-60c0f11b0767)  
...
![voronoi_05](img/noise/voronoi_05.png)  
[[wiki]](https://en.wikipedia.org/wiki/Taxicab_geometry)

![voronoi_06](img/noise/voronoi_06.png)  
...
![dual](img/noise/dual.gif)
[[jakerice]](https://medium.com/@jakerice_7202/computing-the-dual-ff2a93077e2e)

[![dual_01](img/noise/dual_01.png)](https://medium.com/@jakerice_7202/computing-the-dual-ff2a93077e2e)  
[[jakerice]](https://medium.com/@jakerice_7202/computing-the-dual-ff2a93077e2e)
...
![houdini_01](img/noise/houdini_01.png)  
[[sidefx]](https://vimeo.com/75313908)

![houdini_02](img/noise/houdini_02.png)  
