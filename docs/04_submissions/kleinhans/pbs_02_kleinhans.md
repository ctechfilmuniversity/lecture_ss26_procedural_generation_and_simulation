...
I created four cubes with four materials to see the steps from a basic growing circle (left) to an rotating, almost 3D-locking, Pinwheel (right). This was more like a repetition of the content from class but it helped me to get a better understanding and also to get familiar with Unreal Engine materials. 
...
I experimented in the Node Tree especially with the Time Node.
**Node Tree example (Pinwheel, right)**
...
I challenged myself by continiouing working in Unreal Engine even if it did not really feel intuitive for me. Besides that, I wanted to work exclusively with the scripts and tutorials, without using AI, which really helped me understand the code step by step (at least in principle, not every bit of syntax). If I had include AI in my process of course I would have archieve a more complex pattern in the scope of the submission, but I am quite happy, that I managed it this way :)
