...
![Image](img/pgs_03/cubes.jpeg)

Link: https://owncloud.gwdg.de/index.php/s/A7EJFRQPFEMSTzY
...
*Submission*:  
This was by far the hardest task for me because for some reason I made a bunch of mistakes in this one and had a lot of technical difficulties out of my control.  
A learning for me was finishing it on a different device because some problems only arose on mine.  
Through my mistakes and explaining the “wrong results” that were conflicting with the tutorial to an AI, I was actually learning more. I was able to integrate the amount of generations into the force of the next generation of cubes jumping, the inbetween time the cubes will break and the color change.  
For the documentation I learned how to work with the camera, get movement into it and export visuals. 
