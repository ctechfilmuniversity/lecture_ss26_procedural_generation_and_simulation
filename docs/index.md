...
| ------ | ------- | --------------- | --------------- |
| 03.06. | **1**   | Introduction    | Topics          |
|        |         |                 | Tools           |
|        |         |                 | Abstraction     |
| 10.06. | **2**   | Beauty in Maths | Numbers         |
|        |         |                 | Formulas        |
| 11.06. | **3**   | Pattern         | Function Design |
| 17.06. | **4**   | Tilings         | Islamic Designs |
| 18.06. | **5**   | Noise           | Properties      |
|        |         |                 | Function        |
|        |         |                 | Cellular        |
| 24.06. | **6**   | Dynamics        | Forces          |
| 25.06. | **7**   | Agency          | Particles I     |
| 01.07. | **8**   | Complex Systems | Particles II    |
| 02.07. | **9**   |                 | tba             |
...
* It is indicated in the session, if a polished result is expected or if work in progress is sufficient.
* Sessions might include options, e.g., one task being more VFX-oriented and another one more CTech-focused. It is up to you to chose from the given option, you do not have to chose based on your study program.
...
* The (hard) deadline for the final project is **19 October**. The deadline for the final project is strict and for a late submission, I reduce **15% of the total points**.
...
* All materials are handled through the GitHub repository `lecture_ss26_procedural_generation_and_simulation` and you also hand in your results through GitHub.
...
* In [`Submissions`](04_submissions) you submit your work each week to the folder with your last name and a folder with the session index. You will submit all assignments to the same folder (the one with your last name).
    * If not stated otherwise, do not upload your source, e.g., Unreal files. I only want to see result renderings.
...
* **Participation**: you are invited, encouraged, and expected to engage actively in discussion, reflection and activities. Also, you can exist for a few hours without chatting, texting or emailing on your computer and phone. It is distracting for everybody if you don't pay attention, and I prefer that you only come to class if you are actually focus on the class. 
